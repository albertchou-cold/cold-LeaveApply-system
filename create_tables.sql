...
CREATE INDEX IF NOT EXISTS idx_leave_applications_applied_at ON leave_applications(applied_at);
CREATE INDEX IF NOT EXISTS idx_leave_applications_random_unique_id ON leave_applications(RandomUniqueId);
